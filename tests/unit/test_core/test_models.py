...
from core.models import BoundingBox, LayoutElement, ServicePageResult
...
class TestLayoutElement:
    ...
    def test_initialization(self):
        ...
        element = LayoutElement(label="title", x1=10, y1=20, x2=100, y2=50)
    ...
    def test_to_dict(self):
        ...
        element = LayoutElement(
            label="heading", x1=5, y1=10, x2=50, y2=30, text="Test Heading", crop_image="base64data"
        )
    ...
    def test_default_optional_fields(self):
        ...
        element = LayoutElement(label="text", x1=0, y1=0, x2=10, y2=10)
