...
class SpatialConfig:
    ...
    hierarchy_thresholds: Dict[int, float] = field(default_factory=lambda: {
    ...
    barrier_labels: frozenset = field(default_factory=lambda: frozenset({
        "title", "sub_title", "subtitle", "heading",
        "equation", "formula",
        "image", "figure",
        "table", "tablecaption", "tablefootnote",
        "imagecaption", "caption",
        "section_heading", "title_block", "abstract",
    }))
